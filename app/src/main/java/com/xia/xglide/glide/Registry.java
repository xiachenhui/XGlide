...
import com.xia.xglide.glide.load.LoadPath;
import com.xia.xglide.glide.load.codec.ResourceDecoder;
import com.xia.xglide.glide.load.codec.ResourceDecoderRegistry;
...
public class Registry {
    ...
    private final ModelLoaderRegister modelLoaderRegistry = new ModelLoaderRegister();
    ...
    public <Model> List<ModelLoader<Model, ?>> getModelLoaders(Model model) {
        ...
        List<ModelLoader<Model, ?>> modelLoaders = modelLoaderRegistry.getModelLoader(modelClass);
        return modelLoaders;
    }
